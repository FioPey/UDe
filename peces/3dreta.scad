...
grosor=5;//profunditat
size=15;//mida
translate([30,0,55])
{
    translate([0,0,18])rotate([90,0,90])write("U",t=grosor,h=size,center=true);
    translate([-1,0,0])rotate([90,0,90])write("D",t=2*grosor,h=size,center=true);
    translate([-2.5,0,-18])rotate([90,0,90])write("E",t=grosor,h=size,center=true);
}
}
